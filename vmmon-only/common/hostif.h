...
EXTERN VMCrossPage *HostIF_AllocCrossPage(VMDriver *vm);
EXTERN void  HostIF_FreeCrossPage(VMDriver *vm, VMCrossPage *crosspage);
EXTERN MPN   HostIF_GetCrossPageMPN(VMCrossPage *crosspage);
